...
Project:    SweetCaptcha SDK
----------------------------------------------------------------------------*/
define('SWEETCAPTCHA_APP_ID',123456789);                // app id 
define('SWEETCAPTCHA_KEY', 'my_app_key');               // app key 
define('SWEETCAPTCHA_SECRET', 'my_app_secret_key');     // app secret key
define('SWEETCAPTCHA_PUBLIC_URL', 'sweetcaptcha.php');  // url to this file
